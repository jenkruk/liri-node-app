...
1.  Next, or at index 1, type the name of the js file, in this case 'liri.js'
1.  Next, or at index 2, type one of the following commands:
    1. concert-this
    1. spotify-this-song
    1. movie-this
    1. do-what-it-says

1. Lastly, at index 3, type either the name of an artist or band, song or movie accordingly.  If you typed
...
and then install it as a dependency by including the following line in your .js file:** 
...
### Link to video: 
https://drive.google.com/file/d/1yD_9lm9AuA056ZyQB24D0yiudCzvVcIT/view
